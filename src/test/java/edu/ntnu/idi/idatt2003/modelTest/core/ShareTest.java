...
public class ShareTest {
  ...
  void constructor_nullQuantity_throwsIllegalArgumentException() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> new Share(stock, null, new BigDecimal("10")));
  }
  ...
  void constructor_nullPurchasePrice_throwsIllegalArgumentException() {
    ...
    assertThrows(IllegalArgumentException.class, () -> new Share(stock, new BigDecimal("1"), null));
  }
