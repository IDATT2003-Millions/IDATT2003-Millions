...
public class StockTest {
  ...
  void constructor_nullSymbol_throwsIllegalArgumentException() {
    IllegalArgumentException ex =
        assertThrows(
            IllegalArgumentException.class, () -> new Stock(null, "Test", new BigDecimal("10")));
  ...
  void constructor_blankSymbol_throwsIllegalArgumentException() {
    assertThrows(
        IllegalArgumentException.class, () -> new Stock("   ", "Test", new BigDecimal("10")));
  }
  ...
  void constructor_nullCompany_throwsIllegalArgumentException() {
    IllegalArgumentException ex =
        assertThrows(
            IllegalArgumentException.class, () -> new Stock("TEST", null, new BigDecimal("10")));
  ...
  void constructor_nullSalesPrice_throwsIllegalArgumentException() {
    IllegalArgumentException ex =
        assertThrows(IllegalArgumentException.class, () -> new Stock("TEST", "Test", null));
  ...
  void constructor_zeroSalesPrice_throwsIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class, () -> new Stock("TEST", "Test", BigDecimal.ZERO));
  }

  @Test
  void constructor_negativeSalesPrice_throwsIllegalArgumentException() {
    assertThrows(
        IllegalArgumentException.class, () -> new Stock("TEST", "Test", new BigDecimal("-1")));
  }
  ...
  void addNewSalesPrice_negative_throwsIllegalArgumentException() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> stock.addNewSalesPrice(new BigDecimal("-0.01")));
  }
